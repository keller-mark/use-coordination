...
mmCMV is a JavaScript library for implementing CMV in React-based visualization systems.
...
However, mmCMV provides several benefits:
...
- Provides an object-oriented API for configuration and construction of JSON representation
