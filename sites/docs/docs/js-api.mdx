...
Class to represent a pair of `metaCoordination.coordinationScopes` and `metaCoordination.coordinationScopesBy` coordination scopes in the coordination space.
